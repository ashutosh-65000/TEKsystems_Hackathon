...
<div class="container-fluid">
    ...
    <div class="col-sm-4"></div>
      ...
      %>
      <form action="Forgot" name="form" method="post" class="logininput">
          <input type="hidden" name="whocalling" value="student_login">
          <input type="email" name="email" placeholder="Email" class="logininputbox"><br>
	  <input type="submit" value="Forgot Password" style="background: #3fc73ffa;border: green;padding: 5px;border-radius: 20%;"><br><br>
		</form></div>
    <div class="col-sm-4"></div>
	</div>
</div>
