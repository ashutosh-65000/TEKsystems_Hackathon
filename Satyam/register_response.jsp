<%-- 
    ...
    Created on : Aug 30, 2019, 4:43:42 PM
    Author     : Dell
--%>
...
<div class="container-fluid">
    ...
    <div class="col-sm-4"></div>
      ...
      <% String s1 = (String)session.getAttribute("register");
        if(s1!=null)
       { %>
      <h2><p style="color:red"><Strong><%= s1 %></strong></p></h2>
      <%
          session.setAttribute("register",null);
          }
      %>
       <% String s2 = (String)session.getAttribute("LoginIn");
        if(s2!=null)
       { %>
      <h2><p style="color:red"><Strong><%= s2 %></strong></p></h2>
      <%
          session.setAttribute("LoginIn",null);
          }
      %>
      <form action="Login" name="form" method="post" class="logininput">
          <input type="hidden" name="whocalling" value="login_response">
